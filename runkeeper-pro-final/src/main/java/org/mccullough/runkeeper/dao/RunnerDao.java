package org.mccullough.runkeeper.dao;
...
public interface RunnerDao {
     ...
     *
     * @param raceId the race for which we want the results
     * @param numToShow shows this number of runners
     * @return all runners as a list of Runner objects
     * ordered by race time.
     */
    List<Runner> getFastestRunnersByRace(int raceId, int numToShow);
